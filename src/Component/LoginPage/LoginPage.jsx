...
<img src={horse} className="horse"/>
    ...
    <div className="div1" style={{ background: "white", borderRadius: "10px" }}>
...
/><br />
      <hr className="hr" style={{ color: "lightgray", width: "530px" }} />{" "}
      <text className="OR" style={{ color: "lightgray", background: "white" }}>
        {" "}
        OR{" "}
      </text>
      <br />
...
<br />
       <p style={{color:'gray'}}> Not a member yet? <span style={{
          color: 'navy',
          fontWeight: '500',
